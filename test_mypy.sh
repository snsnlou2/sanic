...
yes | scp -i root_key ./mypy_test_cache.zip root@$serverIp:~/cache/sanic-org---sanic-Pair13-after.zip
yes | scp -i root_key ./mypy_test_report.txt root@$serverIp:~/report/sanic-org---sanic-Pair13-after.txt
